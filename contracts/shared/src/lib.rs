...
pub mod validation {
    ...
    pub fn validate_string(_env: &Env, _text: &str) -> Result<soroban_sdk::String, soroban_sdk::Error> {
        Ok(soroban_sdk::String::from_str(_env, _text))
    }
    
    pub fn sanitize_text(_env: &Env, _text: &str) -> Result<soroban_sdk::String, soroban_sdk::Error> {
        Ok(soroban_sdk::String::from_str(_env, _text))
    }
}
